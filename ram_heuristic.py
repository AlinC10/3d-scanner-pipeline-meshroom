...
def calculate_required_ram(
    ...
    k_coeff = 0.06 if depthmap_downscale == 1 else 0.02
    
    # Calculate components
    base_ram = overhead
    feature_ram = num_images * resolution_mp * k_coeff
...
if __name__ == "__main__":
    ...
    print(f"RAM for {test_n} images, downscale 1, 10M points: {calculate_required_ram(test_n, depthmap_downscale=1)} GB")
